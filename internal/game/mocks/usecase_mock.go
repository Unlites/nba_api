...
// Source: internal/game/usecase.go
...
func (m *MockUseCase) Create(game *models.Game) error {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) GetById(id int64) (*models.Game, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) Update(game *models.Game) error {
	m.ctrl.T.Helper()
